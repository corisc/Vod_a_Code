...
public class RobotSequenceClicker2 {

  private Robot robot;

  public static void main(String args[]) throws Exception {
    new RobotSequenceClicker2();
  }

  // https://youtu.be/GSgsQMECF9E

  public RobotSequenceClicker2() throws Exception {
      ...
      for (int t = 0; t < records.get(0).size(); t = t + 3) {
        ...
        this.robot.mouseMove(new Integer(records.get(0).get(t)).intValue(),
          ...
          if (mins == 9999){
            ...
            Color c = this.robot.getPixelColor(220, 200);
            if(c.getRed() == 34 & c.getBlue() == 34 & c.getGreen() == 34){
              mins = 1;
              this.robot.mousePress(InputEvent.BUTTON1_MASK);
              this.robot.mouseRelease(InputEvent.BUTTON1_MASK);
              this.robot.delay(50);
  ...
  public RobotSequenceClicker2(Robot robot) {
    this.robot = robot;
  }
