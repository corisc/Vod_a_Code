...
public class Permutator {
  ...
  private static Vector<DataRow> ursprungsDatenreihen = new Vector<DataRow>();

  public DataRow permutiere(int permutation, double... punkte) {
    ...
    DataRow ent = datenreihen.holeDatenReiheAnStelle(permutation);
    // for(int a=0;a<4;a++){
  ...
  public DataRow punktePermutieren(DataRow datenReihe) {
    DataRow result = new DataRow();
    if (datenReihe == null) {
      return result;
    }
  ...
  public DataRow inhaltPermutieren(DataRow datenReihe) {
  ...
  public DataRow permutiereStrings(DataRow d) {
  ...
  public DataRow permutiereDouble(DataRow d) {
    int size = d.liefereZahlDerEintraege();
    java.util.List<Object> arr = new Vector<Object>();
    for (int t = 0; t < size; t++) {
