...
public class TextGraphic extends JPanel {
  ...
  public TextGraphic(String text, int x1, int y1){
    this.x1 = x1;
    this.y1 = y1;
    this.text = text;
  }

  public TextGraphic(String text, int x1, int y1, String farbe){
    this.x1 = x1;
    this.y1 = y1;
    this.text = text;
    this.farbe = farbe;
  ...
  public TextGraphic(String text, int x1, int y1, int textSize, boolean fett, String farbe){
    this.x1 = x1;
    this.y1 = y1;
    this.text = text;
