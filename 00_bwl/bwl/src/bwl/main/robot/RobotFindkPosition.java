...
public class RobotFindkPosition {

  private Robot robot;

  public static void main(String args[]) throws Exception {
    new RobotFindkPosition();
  }

  // https://youtu.be/GSgsQMECF9E
  
  public RobotFindkPosition() throws Exception {
  ...
  public RobotFindkPosition(Robot robot) {
    this.robot = robot;
  }
