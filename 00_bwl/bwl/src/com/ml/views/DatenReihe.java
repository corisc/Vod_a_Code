...
public class DatenReihe {
  ...
  public void hinzufuegen(DatenReihe datenReihe){
  ...
  public Punkt holePunktAnStelle(int posx, int posy){
    Punkt result = new Punkt(0,0,"kein Punkt gefunden");
    DatenReihe current = null;
    try{
      current = (DatenReihe)this.holeDatenReiheAnStelle(posx);
    }
    catch(Exception e){
  ...
  public DatenReihe holeDatenReiheAnStelle(int stelle){
    DatenReihe result = new DatenReihe();
    try{
      result = (DatenReihe)this.reihe.get(stelle);
    }
    catch(Exception e){
