...
public class Instagram {
  ...
  public Instagram() throws Exception {
    Thread.sleep(2000);
...
//    Color c = this.robot.getPixelColor(2850, 300);
//    System.out.println(""+c);

//    for (int t = 0; t <= 1000; t++) {
//      this.robot = new Robot();
//      // Klick auf "alle ansehen"
//      this.robot.mouseMove(2925, 300);
//
//      this.robot.mousePress(InputEvent.BUTTON1_MASK);
//      this.robot.mouseRelease(InputEvent.BUTTON1_MASK);
//
//      Thread.sleep(1000);
//      this.robot.mouseMove(2925, 300+t);
//
//      for (int tt = 0; tt < 80; tt++) {
//        Thread.sleep(30000);
//        Color c = this.robot.getPixelColor(2500, 800);
//        if (c.getRed() == 0 && c.getBlue() == 0 && c.getGreen() == 0) {
//          for (int ttt = 0; ttt < 5; ttt++) {
//            // Ein Pfeil auf der Story wenn es haengt
//            this.robot.mouseMove(3027, 1030);
//            this.robot.mousePress(InputEvent.BUTTON1_MASK);
//            this.robot.mouseRelease(InputEvent.BUTTON1_MASK);
//            Thread.sleep(5000);
//          }
//        }
//        this.robot.mouseMove(100, 1030+tt);
//        
//        c = this.robot.getPixelColor(2850, 300);
