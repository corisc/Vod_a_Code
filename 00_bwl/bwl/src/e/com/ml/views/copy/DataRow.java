...
public class DataRow {
  ...
  public void hinzufuegen(DataRow datenReihe){
  ...
  public Punkt holePunktAnStelle(int posx, int posy){
    ...
    try{
      current = (DataRow)this.holeDatenReiheAnStelle(posx);
    }
    catch(Exception e){
  ...
  public DataRow holeDatenReiheAnStelle(int stelle){
    DataRow result = new DataRow();
    try{
      result = (DataRow)this.reihe.get(stelle);
    }
    catch(Exception e){
