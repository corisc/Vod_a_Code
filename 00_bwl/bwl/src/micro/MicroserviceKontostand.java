...
public class MicroserviceKontostand {
  ...
  public void antworteAufRequest() {
    ...
    try {
      ...
      System.out
          .println("Vermutlich laeuft noch das vorher gestartete Fenster. Das Programm kann nicht zweimal laufen, bitte das alte Fenster erst schlieﬂen.");
      System.out.println("");
      System.out.println("Ergebenste Grueﬂe, Markus Leue");
