...
public class RobotClickPosition {

  private Robot robot;

  public static void main(String args[]) throws Exception {
    new RobotClickPosition();
  }

  // https://youtu.be/GSgsQMECF9E

  public RobotClickPosition() throws Exception {
    ...
    w.zeige(e1, 50, 120, 200);

    Text t2 = new Text("y");
    w.zeige(t2, 50, 160);

    EingabeFeld e2 = new EingabeFeld();
    w.zeige(e2, 50, 180, 200);

    Text t3 = new Text("minutes");
    w.zeige(t3, 50, 220);

    EingabeFeld e3 = new EingabeFeld();
    w.zeige(e3, 50, 240, 200);
    ...
    Text t4 = new Text("Schleife laeuft");
    w1.zeige(t4, 50, 100);
    ...
    for (;;) {
      ...
      this.robot.mouseMove(e1.getGanzahligenWert(), e2.getGanzahligenWert());
      Thread.sleep(50);
  ...
  public RobotClickPosition(Robot robot) {
    this.robot = robot;
  }
